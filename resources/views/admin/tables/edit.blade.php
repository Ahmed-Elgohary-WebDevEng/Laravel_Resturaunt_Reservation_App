        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="overflow-x-auto bg-gray-200 p-4 border-4 border-blue-400 relative">
                <form action="{{ route('admin.tables.update', $table->id) }}" method="POST">
                    ...
                    <div class="mb-6">
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-black-300" for="guest_number">Upload
                            Category Image</label>
                        <input type="number" id="guest_number" name="guest_number" min="0" max="10" step="1.0" value="{{ $table->guest_number }}"
