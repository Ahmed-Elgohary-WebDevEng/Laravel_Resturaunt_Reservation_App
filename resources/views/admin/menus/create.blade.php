        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="overflow-x-auto bg-gray-200 p-4 border-4 border-blue-400 relative">
                ...
                <form action="{{ route('admin.menus.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-6">
                        <label for="price" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Menu
                            Price</label>
                    ...
                    <div class="mb-6">
                        <label for="decription" class="block mb-2 text-sm font-medium text-black-900 dark:text-black-400">Menu Description</label>
                        <textarea id="decription" rows="4" name="description"
