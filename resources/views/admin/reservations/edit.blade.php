        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="overflow-x-auto bg-gray-200 p-4 border-4 border-blue-400 relative">
                ...
                <form action="{{ route('admin.reservations.update', $reservation->id) }}" method="post">
                    ...
                    @method('PUT')
                    <div class="mb-6">
                        <label for="first_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">First
                            Name</label>
                    ...
                    <div class="mb-6">
                        <label for="guest_number" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Guest Number</label>
